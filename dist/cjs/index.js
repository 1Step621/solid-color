...
var _tmpl$$J = /*#__PURE__*/web.template(`<div><div></div><div></div><div><div>`),
...
const Alpha$1 = _props => {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.a = web.style(_el$3, _v$3, _p$.a);
      _p$.o = web.style(_el$4, _v$4, _p$.o);
      _p$.i = web.style(_el$5, _v$5, _p$.i);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$I = /*#__PURE__*/web.template(`<label>`),
...
function EditableInput(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.e = web.style(_el$, _v$, _p$.e);
      _p$.t = web.style(_el$2, _v$2, _p$.t);
      _v$3 !== _p$.a && web.setAttribute(_el$2, "placeholder", _p$.a = _v$3);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$H = /*#__PURE__*/web.template(`<div><div></div><div>`);
...
const ColorPickerContext = solidJs.createContext({
  colors: () => ({
    hex: '',
    rgb: {
      r: 0,
...
var _tmpl$$F = /*#__PURE__*/web.template(`<div tabindex=0>`);
const ENTER = 13;
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      var _v$ = styles().color,
        ...
        _v$4 = styles().pointer;
      _p$.e = web.style(_el$, _v$, _p$.e);
      _p$.t = web.style(_el$3, _v$2, _p$.t);
      _p$.a = web.style(_el$4, _v$3, _p$.a);
      _p$.o = web.style(_el$5, _v$4, _p$.o);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$D = /*#__PURE__*/web.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"stroke-width=0.5><path d=M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z>`),
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      var _v$ = `${props.width}px`,
        ...
        _v$3 = props.fill,
        _v$4 = props.stroke;
      _v$ !== _p$.e && web.setAttribute(_el$, "width", _p$.e = _v$);
      _v$2 !== _p$.t && web.setAttribute(_el$, "height", _p$.t = _v$2);
      _v$3 !== _p$.a && web.setAttribute(_el$, "fill", _p$.a = _v$3);
      _v$4 !== _p$.o && web.setAttribute(_el$, "stroke", _p$.o = _v$4);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
function UnfoldMoreHorizontalIcon(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _v$5 !== _p$.e && web.setAttribute(_el$2, "width", _p$.e = _v$5);
      _v$6 !== _p$.t && web.setAttribute(_el$2, "height", _p$.t = _v$6);
      return _p$;
    }, {
      e: undefined,
      t: undefined
...
var _tmpl$$A = /*#__PURE__*/web.template(`<div><div class=flexbox-fix><div></div><div></div><div>`);
  ...
  return web.createComponent(Raised, {
    ...
    get children() {
      ...
      web.effect(_p$ => {
        ...
        _v$2 !== _p$.t && web.className(_el$, _p$.t = _v$2);
        _p$.a = web.style(_el$2, _v$3, _p$.a);
        _p$.o = web.style(_el$3, _v$4, _p$.o);
        _p$.i = web.style(_el$4, _v$5, _p$.i);
        _p$.n = web.style(_el$5, _v$6, _p$.n);
        return _p$;
      }, {
        e: undefined,
        t: undefined,
...
var _tmpl$$z = /*#__PURE__*/web.template(`<div>`);
...
var _tmpl$$y = /*#__PURE__*/web.template(`<div>`);
...
var _tmpl$$x = /*#__PURE__*/web.template(`<div><div></div><div></div><div><div>#</div><div>`);
const Twitter = _props => {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.i = web.style(_el$4, _v$5, _p$.i);
      _p$.n = web.style(_el$5, _v$6, _p$.n);
      _p$.s = web.style(_el$6, _v$7, _p$.s);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$w = /*#__PURE__*/web.template(`<div><div>`);
const BlockSwatches = ({
  colors,
  onClick
}) => {
...
var _tmpl$$v = /*#__PURE__*/web.template(`<div><div></div><div><div></div></div><div>`);
const Block = _props => {
  const props = solidJs.mergeProps({
  ...
  return (() => {
    ...
    web.insert(_el$5, web.createComponent(BlockSwatches, {
      get colors() {
        return props.colors;
      },
      onClick: handleChange
...
var _tmpl$$u = /*#__PURE__*/web.template(`<div>`);
...
var _tmpl$$t = /*#__PURE__*/web.template(`<div>`);
...
var _tmpl$$s = /*#__PURE__*/web.template(`<div><div></div><div></div><div></div><div></div><div></div><div>`);
function SliderSwatches(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.o = web.style(_el$4, _v$4, _p$.o);
      _p$.i = web.style(_el$5, _v$5, _p$.i);
      _p$.n = web.style(_el$6, _v$6, _p$.n);
      _p$.s = web.style(_el$7, _v$7, _p$.s);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$r = /*#__PURE__*/web.template(`<div><div></div><div>`);
const Slider = _props => {
  const props = solidJs.mergeProps({
...
var _tmpl$$p = /*#__PURE__*/web.template(`<div><div></div><div>`);
...
var _tmpl$$n = /*#__PURE__*/web.template(`<div class=flexbox-fix><div>`);
...
var _tmpl$$m = /*#__PURE__*/web.template(`<div><div><div>`);
...
var _tmpl$$j = /*#__PURE__*/web.template(`<div><div><div>`),
...
function Swatches(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.e = web.style(_el$, _v$4, _p$.e);
      _v$5 !== _p$.t && web.className(_el$, _p$.t = _v$5);
      return _p$;
    }, {
      e: undefined,
      t: undefined
...
var _tmpl$$i = /*#__PURE__*/web.template(`<div><div>`);
...
function Circle(_props) {
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(solidJs.For, {
      ...
      children: c => web.createComponent(CircleSwatch, {
        color: c,
        onClick: handleChange,
        get active() {
...
var _tmpl$$g = /*#__PURE__*/web.template(`<div class=flexbox-fix><div><div></div><div><div></div><div></div><div>`);
...
function GooglePointer(_props) {
  ...
  return (() => {
    ...
    web.effect(_$p => (_$p = `hsl(${Math.round(props.hsl.h)}, 100%, 50%)`) != null ? _el$.style.setProperty("background", _$p) : _el$.style.removeProperty("background"));
    return _el$;
  })();
}
...
function GooglePointerCircle(_props) {
  ...
  return (() => {
    ...
    web.effect(_$p => (_$p = `hsl(${Math.round(props.hsl.h)}, ${Math.round(props.hsl.s * 100)}%, ${Math.round(props.hsl.l * 100)}%)`) != null ? _el$.style.setProperty("background", _$p) : _el$.style.removeProperty("background"));
    return _el$;
  })();
}

var _tmpl$$d = /*#__PURE__*/web.template(`<div><div></div><div></div><div></div><div><div class=flexbox-fix><div>`);
function Google(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.n = web.style(_el$5, _v$6, _p$.n);
      _p$.s = web.style(_el$6, _v$7, _p$.s);
      _p$.h = web.style(_el$7, _v$8, _p$.h);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$c = /*#__PURE__*/web.template(`<div class=flexbox-fix><div>`),
  ...
  return (() => {
      ...
      get children() {
        ...
        web.effect(_p$ => {
          var _v$3 = styles().fields,
            ...
            _v$6 = styles().field,
            _v$7 = styles().alpha;
          _p$.e = web.style(_el$4, _v$3, _p$.e);
          _p$.t = web.style(_el$5, _v$4, _p$.t);
          _p$.a = web.style(_el$6, _v$5, _p$.a);
          _p$.o = web.style(_el$7, _v$6, _p$.o);
          _p$.i = web.style(_el$8, _v$7, _p$.i);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
      ...
      get children() {
        ...
        web.effect(_p$ => {
          var _v$8 = styles().fields,
            ...
            _v$11 = styles().field,
            _v$12 = styles().alpha;
          _p$.e = web.style(_el$9, _v$8, _p$.e);
          _p$.t = web.style(_el$10, _v$9, _p$.t);
          _p$.a = web.style(_el$11, _v$10, _p$.a);
          _p$.o = web.style(_el$12, _v$11, _p$.o);
          _p$.i = web.style(_el$13, _v$12, _p$.i);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
    ...
    web.effect(_p$ => {
      var _v$13 = styles().wrap,
        _v$14 = styles().toggle,
        _v$15 = styles().icon;
      _p$.e = web.style(_el$, _v$13, _p$.e);
      _p$.t = web.style(_el$14, _v$14, _p$.t);
      _p$.a = web.style(_el$15, _v$15, _p$.a);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$9 = /*#__PURE__*/web.template(`<div><div></div><div><div class=flexbox-fix><div><div><div></div></div></div><div><div></div><div>`);
const Chrome = _props => {
  const props = solidJs.mergeProps({
    width: 225,
    disableAlpha: false,
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.s = web.style(_el$6, _v$7, _p$.s);
      _p$.h = web.style(_el$7, _v$8, _p$.h);
      _p$.r = web.style(_el$8, _v$9, _p$.r);
      _p$.d = web.style(_el$9, _v$10, _p$.d);
      _p$.l = web.style(_el$10, _v$11, _p$.l);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$8 = /*#__PURE__*/web.template(`<div class=flexbox-fix><div></div><div></div><div></div><div></div><div>`);
...
var _tmpl$$7 = /*#__PURE__*/web.template(`<div class=flexbox-fix>`),
...
var _tmpl$$6 = /*#__PURE__*/web.template(`<div><div></div><div class=flexbox-fix><div><div></div><div></div></div><div><div>`);
function Sketch(_props) {
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(SketchFields, {
      get rgb() {
        return colors().rgb;
      },
      get hsl() {
...
var _tmpl$$4 = /*#__PURE__*/web.template(`<div><div></div><div></div><div><div>°</div><div>%</div><div>%`);
...
var _tmpl$$3 = /*#__PURE__*/web.template(`<div><div><div></div></div><div><div>`);
...
function PhotoshopPointerCircle(_props) {
  ...
  return (() => {
    ...
    _el$.style.setProperty("transform", "translate(-6px, -6px)");
    web.effect(_$p => (_$p = props.hsl.l > 0.5 ? 'inset 0 0 0 1px #000' : 'inset 0 0 0 1px #fff') != null ? _el$.style.setProperty("boxShadow", _$p) : _el$.style.removeProperty("boxShadow"));
    return _el$;
  })();
}

var _tmpl$$1 = /*#__PURE__*/web.template(`<div><div>new</div><div><div></div><div></div></div><div>current`);
function PhotoshopPreviews(_props) {
  ...
  return (() => {
    ...
    web.effect(_p$ => {
      ...
      _p$.a = web.style(_el$4, _v$3, _p$.a);
      _p$.o = web.style(_el$5, _v$4, _p$.o);
      _p$.i = web.style(_el$6, _v$5, _p$.i);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$ = /*#__PURE__*/web.template(`<div><div></div><div class=flexbox-fix><div></div><div></div><div><div class=flexbox-fix><div></div><div>`);
