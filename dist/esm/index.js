...
function SliderSwatches(_props) {
  ...
  return (() => {
    ...
    insert(_el$5, createComponent(SliderSwatch, {
      ...
      offset: 0.35,
      get active() {
        return memo(() => Math.abs(props.hsl.l - 0.35) < epsilon)() && Math.abs(props.hsl.s - 0.5) < epsilon;
      },
      get onClick() {
        return props.onClick;
      }
    }));
    insert(_el$6, createComponent(SliderSwatch, {
      get hsl() {
        return props.hsl;
      },
      offset: 0.2,
      get active() {
        return memo(() => Math.abs(props.hsl.l - 0.2) < epsilon)() && Math.abs(props.hsl.s - 0.5) < epsilon;
      },
      get onClick() {
        return props.onClick;
      },
    ...
    effect(_p$ => {
      ...
      _p$.o = style(_el$4, _v$4, _p$.o);
      _p$.i = style(_el$5, _v$5, _p$.i);
      _p$.n = style(_el$6, _v$6, _p$.n);
      _p$.s = style(_el$7, _v$7, _p$.s);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
const Slider = _props => {
  ...
  return (() => {
    var _el$ = _tmpl$$r(),
      _el$2 = _el$.firstChild,
      _el$3 = _el$2.nextSibling;
    insert(_el$2, createComponent(Hue$1, {
      radius: 2,
      get hsl() {
        return colors().hsl;
      },
    ...
    insert(_el$3, createComponent(SliderSwatches, {
      get hsl() {
        return colors().hsl;
      },
      onClick: changeColor
...
var _tmpl$$q = /*#__PURE__*/template(`<div><div>`);
function GithubSwatch(_props) {
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Swatch, {
      get color() {
        return props.color;
      },
      get onClick() {
    ...
    effect(_$p => style(_el$2, styles().swatch, _$p));
    return _el$;
  })();
}
delegateEvents(["mouseover", "mouseout"]);
...
function Github(_props) {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: c => createComponent(GithubSwatch, {
        color: c,
        onClick: handleChange
      })
    }), null);
...
function CompactColor(_props) {
  ...
  return createComponent(Swatch, {
    ...
    get children() {
      var _el$ = _tmpl$$o();
      effect(_$p => style(_el$, styles().dot, _$p));
      return _el$;
    }
  });
}

var _tmpl$$n = /*#__PURE__*/template(`<div class=flexbox-fix><div>`);
...
var _tmpl$$m = /*#__PURE__*/template(`<div><div><div>`);
  ...
  return createComponent(Raised, {
    ...
    get children() {
      ...
      insert(_el$2, createComponent(For, {
        ...
        children: c => createComponent(CompactColor, {
          color: c,
          get active() {
      ...
      insert(_el$, createComponent(CompactFields, {
        get hex() {
          return currentColors().hex;
        },
        get rgb() {
...
function SwatchesColor(_props) {
  ...
  return createComponent(Swatch, {
    ...
    get children() {
      ...
      effect(_$p => style(_el$, styles().check, _$p));
      return _el$;
    }
  });
}
...
function SwatchesGroup(_props) {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: (color, i) => createComponent(SwatchesColor, {
        color: color,
        get active() {
    ...
    effect(_$p => style(_el$, styles.group, _$p));
    return _el$;
  })();
}

var _tmpl$$j = /*#__PURE__*/template(`<div><div><div>`),
...
function Swatches(_props) {
  ...
  return (() => {
    var _el$ = _tmpl$2$2();
    insert(_el$, createComponent(Raised, {
      get children() {
        var _el$2 = _tmpl$$j(),
          _el$3 = _el$2.firstChild,
          _el$4 = _el$3.firstChild;
        insert(_el$3, createComponent(For, {
          ...
          children: group => createComponent(SwatchesGroup, {
            group: group,
            get active() {
              return currentColors().hex;
            },
...
function Circle(_props) {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: c => createComponent(CircleSwatch, {
        color: c,
        onClick: handleChange,
        get active() {
...
var _tmpl$$g = /*#__PURE__*/template(`<div class=flexbox-fix><div><div></div><div><div></div><div></div><div>`);
function GoogleFields(_props) {
  ...
  return (() => {
    ...
    insert(_el$6, createComponent(EditableInput, {
      get styles() {
        return {
          input: styles.input2,
          label: styles.label2
    ...
    insert(_el$7, createComponent(EditableInput, {
      get styles() {
        return {
          input: styles.input2,
          label: styles.label2
...
function GooglePointer(_props) {
  ...
  return (() => {
    ...
    effect(_$p => (_$p = `hsl(${Math.round(props.hsl.h)}, 100%, 50%)`) != null ? _el$.style.setProperty("background", _$p) : _el$.style.removeProperty("background"));
    return _el$;
  })();
}
...
function GooglePointerCircle(_props) {
  ...
  return (() => {
    ...
    effect(_$p => (_$p = `hsl(${Math.round(props.hsl.h)}, ${Math.round(props.hsl.s * 100)}%, ${Math.round(props.hsl.l * 100)}%)`) != null ? _el$.style.setProperty("background", _$p) : _el$.style.removeProperty("background"));
    return _el$;
  })();
}

var _tmpl$$d = /*#__PURE__*/template(`<div><div></div><div></div><div></div><div><div class=flexbox-fix><div>`);
function Google(_props) {
  ...
  return (() => {
    ...
    insert(_el$4, createComponent(Saturation, {
      get hsl() {
        return colors().hsl;
      },
      get hsv() {
      ...
      get pointer() {
        return createComponent(GooglePointerCircle, {
          get hsl() {
            return colors().hsl;
          }
        });
    ...
    insert(_el$7, createComponent(Hue$1, {
      get styles() {
        return styles().Hue;
      },
      get hsl() {
    ...
    insert(_el$5, createComponent(GoogleFields, {
      get rgb() {
        return colors().rgb;
      },
      get hsl() {
...
var _tmpl$$c = /*#__PURE__*/template(`<div class=flexbox-fix><div>`),
  _tmpl$2$1 = /*#__PURE__*/template(`<div class=flexbox-fix><div></div><div></div><div></div><div>`),
  _tmpl$3 = /*#__PURE__*/template(`<div class=flexbox-fix><div><div>`);
  ...
  return (() => {
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$8, createComponent(EditableInput, {
          get styles() {
            return {
              input: styles().input,
              label: styles().label
        ...
        effect(_p$ => {
          var _v$3 = styles().fields,
            _v$4 = styles().field,
            _v$5 = styles().field,
            _v$6 = styles().field,
            _v$7 = styles().alpha;
          _p$.e = style(_el$4, _v$3, _p$.e);
          _p$.t = style(_el$5, _v$4, _p$.t);
          _p$.a = style(_el$6, _v$5, _p$.a);
          _p$.o = style(_el$7, _v$6, _p$.o);
          _p$.i = style(_el$8, _v$7, _p$.i);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$10, createComponent(EditableInput, {
          get styles() {
            return {
              input: styles().input,
              label: styles().label
        ...
        insert(_el$11, createComponent(EditableInput, {
          get styles() {
            return {
              input: styles().input,
              label: styles().label
        ...
        insert(_el$12, createComponent(EditableInput, {
          get styles() {
            return {
              input: styles().input,
              label: styles().label
        ...
        insert(_el$13, createComponent(EditableInput, {
          get styles() {
            return {
              input: styles().input,
              label: styles().label
        ...
        effect(_p$ => {
          var _v$8 = styles().fields,
            _v$9 = styles().field,
            _v$10 = styles().field,
            _v$11 = styles().field,
            _v$12 = styles().alpha;
          _p$.e = style(_el$9, _v$8, _p$.e);
          _p$.t = style(_el$10, _v$9, _p$.t);
          _p$.a = style(_el$11, _v$10, _p$.a);
          _p$.o = style(_el$12, _v$11, _p$.o);
          _p$.i = style(_el$13, _v$12, _p$.i);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
    ...
    insert(_el$15, createComponent(UnfoldMoreHorizontalIcon, {
      width: "24",
      height: "24",
    ...
    effect(_p$ => {
      var _v$13 = styles().wrap,
        _v$14 = styles().toggle,
        _v$15 = styles().icon;
      _p$.e = style(_el$, _v$13, _p$.e);
      _p$.t = style(_el$14, _v$14, _p$.t);
      _p$.a = style(_el$15, _v$15, _p$.a);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$9 = /*#__PURE__*/template(`<div><div></div><div><div class=flexbox-fix><div><div><div></div></div></div><div><div></div><div>`);
const Chrome = _props => {
  const props = mergeProps({
    width: 225,
    disableAlpha: false,
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Saturation, {
      get styles() {
      ...
      get pointer() {
        return createComponent(ChromePointerCircle, {});
      },
      onChange: changeColor
    }));
    insert(_el$6, createComponent(Checkboard, {
      get renderers() {
        return props.renderers;
      }
    }), null);
    insert(_el$9, createComponent(Hue$1, {
      get styles() {
        return styles().Hue;
      },
      get hsl() {
    ...
    insert(_el$10, createComponent(Alpha$1, {
      direction: "horizontal",
      get styles() {
        return styles().Alpha;
      },
    ...
    insert(_el$3, createComponent(ChromeFields, {
      get rgb() {
        return colors().rgb;
      },
      get hsl() {
    ...
    effect(_p$ => {
      ...
      _p$.s = style(_el$6, _v$7, _p$.s);
      _p$.h = style(_el$7, _v$8, _p$.h);
      _p$.r = style(_el$8, _v$9, _p$.r);
      _p$.d = style(_el$9, _v$10, _p$.d);
      _p$.l = style(_el$10, _v$11, _p$.l);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$8 = /*#__PURE__*/template(`<div class=flexbox-fix><div></div><div></div><div></div><div></div><div>`);
const SketchFields = _props => {
  ...
  return (() => {
    var _el$ = _tmpl$$8(),
      ...
      _el$5 = _el$4.nextSibling,
      _el$6 = _el$5.nextSibling;
    insert(_el$2, createComponent(EditableInput, {
      get styles() {
        return {
          input: styles().input,
          label: styles().label
...
var _tmpl$$7 = /*#__PURE__*/template(`<div class=flexbox-fix>`),
  ...
  return (() => {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: colorObjOrString => {
        ...
        return (() => {
          var _el$2 = _tmpl$2();
          insert(_el$2, createComponent(Swatch, mergeProps$1(c, {
            get styles() {
              return styles().swatch;
            },
            onClick: handleClick,
          ...
          effect(_$p => style(_el$2, styles().swatchWrap, _$p));
          return _el$2;
        })();
      }
    }));
    effect(_$p => style(_el$, styles().colors, _$p));
    return _el$;
  })();
}

var _tmpl$$6 = /*#__PURE__*/template(`<div><div></div><div class=flexbox-fix><div><div></div><div></div></div><div><div>`);
function Sketch(_props) {
  ...
  return (() => {
    ...
    insert(_el$5, createComponent(Hue$1, {
      get styles() {
        return styles().Hue;
      },
      get hsl() {
    ...
    insert(_el$6, createComponent(Alpha$1, {
      direction: "horizontal",
      get styles() {
        return styles().Alpha;
      },
    ...
    insert(_el$7, createComponent(Checkboard, {}), _el$8);
    insert(_el$, createComponent(SketchFields, {
      get rgb() {
        return colors().rgb;
      },
      get hsl() {
    ...
    insert(_el$, createComponent(SketchPresetColors, {
      get colors() {
...
function PhotoshopButton(_props) {
  ...
  return (() => {
    ...
    insert(_el$, () => props.label || props.children);
    effect(_$p => style(_el$, styles().button, _$p));
    return _el$;
  })();
}
delegateEvents(["click"]);

var _tmpl$$4 = /*#__PURE__*/template(`<div><div></div><div></div><div><div>°</div><div>%</div><div>%`);
...
var _tmpl$$3 = /*#__PURE__*/template(`<div><div><div></div></div><div><div>`);
...
function PhotoshopPointerCircle(_props) {
  ...
  return (() => {
    ...
    _el$.style.setProperty("transform", "translate(-6px, -6px)");
    effect(_$p => (_$p = props.hsl.l > 0.5 ? 'inset 0 0 0 1px #000' : 'inset 0 0 0 1px #fff') != null ? _el$.style.setProperty("boxShadow", _$p) : _el$.style.removeProperty("boxShadow"));
    return _el$;
  })();
}

var _tmpl$$1 = /*#__PURE__*/template(`<div><div>new</div><div><div></div><div></div></div><div>current`);
...
var _tmpl$ = /*#__PURE__*/template(`<div><div></div><div class=flexbox-fix><div></div><div></div><div><div class=flexbox-fix><div></div><div>`);
function Photoshop(_props) {
  ...
  return (() => {
    ...
    insert(_el$4, createComponent(Saturation, {
      ...
      get pointer() {
        return createComponent(PhotoshopPointerCircle, {
          get hsl() {
            return colors().hsl;
          }
        });
    ...
    insert(_el$8, createComponent(PhotoshopPreviews, {
      get rgb() {
        return colors().rgb;
      },
      get currentColor() {
    ...
    insert(_el$9, createComponent(PhotoshopButton, {
      label: "OK",
    ...
    insert(_el$9, createComponent(PhotoshopPicker, {
      onChange: changeColor,
      get rgb() {
        return colors().rgb;
      },
...
export { Alpha as AlphaPicker, Block$1 as BlockPicker, Chrome$1 as ChromePicker, Circle$1 as CirclePicker, Compact$1 as CompactPicker, Github$1 as GithubPicker, Google$1 as GooglePicker, Hue as HuePicker, Material$1 as MaterialPicker, Photoshop$1 as PhotoshopPicker, Sketch$1 as SketchPicker, Slider$1 as SliderPicker, Swatches$1 as SwatchesPicker, Twitter$1 as TwitterPicker };
