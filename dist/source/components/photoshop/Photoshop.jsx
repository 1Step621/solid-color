...
function Photoshop(_props) {
    ...
    return (<div style={styles.picker} class={`photoshop-picker ${props.className}`}>
      <div style={styles.head}>{props.header}</div>

      <div style={styles.body} class="flexbox-fix">
        <div style={styles.saturation}>
          <Saturation hsl={colors().hsl} hsv={colors().hsv} pointer={<PhotoshopPointerCircle hsl={colors().hsl}/>} onChange={changeColor}/>
        </div>
        <div style={styles.hue}>
          <Hue direction="vertical" hsl={colors().hsl} pointer={PhotoshopPointer} onChange={changeColor}/>
        </div>
        <div style={styles.controls}>
          <div style={styles.top} class="flexbox-fix">
            ...
            <div style={styles.actions}>
              ...
              <PhotoshopFields onChange={changeColor} rgb={colors().rgb} hsv={colors().hsv} hex={colors().hex}/>
            </div>
          </div>
        </div>
      </div>
