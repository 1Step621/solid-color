...
export const Block = (_props) => {
    ...
    return (<div style={styles().card} class={`block-picker ${props.className}`}>
      ...
      <div style={styles().body}>
        ...
        <EditableInput styles={{ input: styles().input }} value={currentColors().hex} onChange={handleChange}/>
      </div>
    </div>);
};
